...
(function () {
  ...
  function applyDesign() {
    ...
    var siteName = (design.siteName || design.logoText || '').trim() || 'Black T-Shirt';
    var logoText = document.querySelector('.logo-text');
    if (logoText) logoText.textContent = siteName;
    var logoLink = document.querySelector('header.site-header .logo');
    if (logoLink) {
      var logoImg = logoLink.querySelector('.logo-img');
      var logoMark = logoLink.querySelector('.logo-mark');
      if (design.logoImage) {
        if (!logoImg) {
        ...
        if (logoMark) logoMark.style.display = '';
      }
    }
